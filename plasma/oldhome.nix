{
  programs.plasma = {
    ...
    shortcuts = {
      ...
      "kwin"."Increase Opacity" = "\\, ,,Increase Opacity of Active Window by 5%";
      ...
      "kwin"."karousel-cycle-preset-widths-reverse" = "Meta+Shift+R,none,Karousel: Cycle through preset column widths in reverse";
    ...
    configFile = {
      ...
      "kcminputrc"."Libinput/1112/393/Genius Wireless Mouse"."PointerAcceleration" = 0.000;
      ...
      "kwinrc"."Script-karousel"."cursorFollowsFocus" = true;
