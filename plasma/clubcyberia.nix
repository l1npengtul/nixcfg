{
  programs.plasma = {
    ...
    dataFile = {
      "kate/anonymous.katesession"."Document 0"."URL" = "file:///home/l1npengtul/nixcfg/hosts/common/userl1npengtul.nix";
      "kate/anonymous.katesession"."Document 1"."URL" = "file:///home/l1npengtul/nixcfg/configuration.nix";
      "kate/anonymous.katesession"."Document 2"."URL" = "file:///home/l1npengtul/nixcfg/flake.lock";
      "kate/anonymous.katesession"."Document 3"."URL" = "file:///home/l1npengtul/nixcfg/pkgs/default.nix";
      "kate/anonymous.katesession"."Document 4"."URL" = "file:///home/l1npengtul/nixcfg/pkgs/sysutils.nix";
      "kate/anonymous.katesession"."Document 5"."URL" = "file:///home/l1npengtul/nixcfg/plasma/clubcyberia.nix";
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-Sidebar-3-Splitter" = 1517;
      ...
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 0"."CursorColumn" = 111;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 0"."CursorLine" = 24;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 4"."CursorColumn" = 208;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 4"."CursorLine" = 1;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 5"."ScrollLine" = 6;
