{
  programs.plasma = {
    ...
    dataFile = {
      "kate/anonymous.katesession"."Document 0"."URL" = "file:///home/l1npengtul/nixcfg/hosts/clubcyberia/hardware-configuration.nix";
      "kate/anonymous.katesession"."Document 1"."URL" = "file:///home/l1npengtul/nixcfg/write_plasmacfg.sh";
      "kate/anonymous.katesession"."Document 2"."URL" = "file:///home/l1npengtul/nixcfg/hosts/clubcyberia/default.nix";
      "kate/anonymous.katesession"."Document 3"."URL" = "file:///home/l1npengtul/nixcfg/plasma/clubcyberia.nix";
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-Sidebar-3-Splitter" = 1524;
      ...
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 2"."CursorColumn" = 22;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 2"."CursorLine" = 22;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 6"."ScrollLine" = 6;
