{
  programs.plasma = {
    enable = true;
    shortcuts = {
      "ActivityManager"."switch-to-activity-3dbd97be-5e9a-4876-b2f8-64f37a3d3b53" = [];
    ...
    configFile = {
      ...
      "kwinrc"."Tiling/4cfec3a8-f8e7-5de3-b1b8-412c187bd7bf"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/6b131951-9adf-5b78-9d2d-25ac7797701c"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
    ...
    dataFile = {
      "kate/anonymous.katesession"."Document 0"."URL" = "file:///home/l1npengtul/nixcfg/write_plasmacfg.sh";
      "kate/anonymous.katesession"."Document 1"."URL" = "file:///home/l1npengtul/nixcfg/plasma/s-23sierpinski.nix";
      "kate/anonymous.katesession"."Document 2"."URL" = "file:///home/l1npengtul/nixcfg/plasma/clubcyberia.nix";
      "kate/anonymous.katesession"."Document 3"."URL" = "file:///home/l1npengtul/nixcfg/flake.nix";
      "kate/anonymous.katesession"."Document 4"."URL" = "file:///home/l1npengtul/nixcfg/users/l1npengtul.nix";
      "kate/anonymous.katesession"."Document 5"."URL" = "file:///home/l1npengtul/nixcfg/users/common.nix";
      "kate/anonymous.katesession"."Document 6"."URL" = "file:///home/l1npengtul/nixcfg/users/common-plasma.nix";
      "kate/anonymous.katesession"."Document 7"."URL" = "file:///home/l1npengtul/nixcfg/pkgs/default.nix";
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-V-Splitter" = "0,831,200";
      ...
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0"."Active View" = 7;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0"."Count" = 8;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0"."Documents" = "0,1,2,3,4,5,6,7";
      ...
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 2"."ScrollLine" = 62;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 3"."CursorColumn" = 0;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 3"."CursorLine" = 231;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 3"."ScrollLine" = 213;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 6"."CursorColumn" = 55;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 6"."CursorLine" = 30;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 6"."ScrollLine" = 3;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 7"."CursorColumn" = 16;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 7"."CursorLine" = 7;
      "kate/anonymous.katesession"."Open Documents"."Count" = 8;
