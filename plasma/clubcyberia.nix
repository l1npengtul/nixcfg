{
  programs.plasma = {
    enable = true;
    shortcuts = {
      "ActivityManager"."switch-to-activity-3dbd97be-5e9a-4876-b2f8-64f37a3d3b53" = "none";
      ...
      "kwin"."Switch One Desktop to the Left" = "Ctrl+Alt+Left\\,Meta+Ctrl+Left\\,Switch One Desktop to the Left";
      "kwin"."Switch One Desktop to the Right" = "Ctrl+Alt+Right\\,Meta+Ctrl+Right\\,Switch One Desktop to the Right";
    ...
    configFile = {
      ...
      "dolphinrc"."General"."ViewPropsTimestamp" = "2025,4,4,14,28,39.081";
      "dolphinrc"."KFileDialog Settings"."Places Icons Auto-resize" = false;
      "dolphinrc"."KFileDialog Settings"."Places Icons Static Size" = 22;
      "kactivitymanagerdrc"."activities"."3dbd97be-5e9a-4876-b2f8-64f37a3d3b53" = "Default";
      "kactivitymanagerdrc"."main"."currentActivity" = "3dbd97be-5e9a-4876-b2f8-64f37a3d3b53";
      ...
      "katerc"."filetree"."viewShade" = "195,209,210";
      ...
      "kdeglobals"."DirSelect Dialog"."DirSelectDialog Size" = "820,582";
      "kdeglobals"."DirSelect Dialog"."Splitter State" = "x00x00x00xffx00x00x00x01x00x00x00x02x00x00x00dx00x00x02xa8x00xffxffxffxffx01x00x00x00x01x00";
      ...
      "kdeglobals"."KFileDialog Settings"."Speedbar Width" = 84;
      ...
      "kwinrc"."Activities/LastVirtualDesktop"."3dbd97be-5e9a-4876-b2f8-64f37a3d3b53" = "c2b1d068-9c40-4d3a-9ed1-48dc5f53d218";
      "kwinrc"."Desktops"."Id_1" = "c2b1d068-9c40-4d3a-9ed1-48dc5f53d218";
      "kwinrc"."Desktops"."Id_2" = "5e2eccc8-b64e-49fc-bdc7-6024c5e3a4b4";
      "kwinrc"."Desktops"."Id_3" = "048ef8d2-93fc-46c0-84d8-047350247802";
      "kwinrc"."Desktops"."Id_4" = "702a10e3-297b-4252-95f8-648a13517dbd";
      ...
      "spectaclerc"."Annotations"."freehandStrokeWidth" = 12;
      "spectaclerc"."GuiConfig"."captureMode" = 0;
      "spectaclerc"."ImageSave"."lastImageSaveLocation" = "file:///home/l1npengtul/Pictures/Screenshots/Screenshot_20250601_151338.png";
      "spectaclerc"."ImageSave"."translatedScreenshotsFolder" = "Screenshots";
      "spectaclerc"."VideoSave"."translatedScreencastsFolder" = "Screencasts";
    };
    dataFile = {
      "kate/anonymous.katesession"."Document 0"."URL" = "file:///home/l1npengtul/nixcfg/pkgs/audio/test.nix";
      "kate/anonymous.katesession"."Document 1"."URL" = "file:///home/l1npengtul/nixcfg/pkgs/audio/default.nix";
      "kate/anonymous.katesession"."Document 10"."URL" = "file:///home/l1npengtul/nixcfg/applications/individual/resolve.nix";
      "kate/anonymous.katesession"."Document 11"."URL" = "file:///home/l1npengtul/nixcfg/applications/individual/rustrover.nix";
      "kate/anonymous.katesession"."Document 12"."URL" = "file:///home/l1npengtul/nixcfg/applications/individual/vscode.nix";
      "kate/anonymous.katesession"."Document 13"."URL" = "file:///home/l1npengtul/nixcfg/applications/individual/vlc.nix";
      "kate/anonymous.katesession"."Document 14"."URL" = "file:///home/l1npengtul/nixcfg/applications/individual/ytdlp.nix";
      "kate/anonymous.katesession"."Document 15"."URL" = "file:///home/l1npengtul/nixcfg/applications/individual/openutau.nix";
      "kate/anonymous.katesession"."Document 16"."URL" = "file:///home/l1npengtul/nixcfg/applications/individual/direnv.nix";
      "kate/anonymous.katesession"."Document 17"."URL" = "file:///home/l1npengtul/nixcfg/applications/individual/blender.nix";
      "kate/anonymous.katesession"."Document 18"."URL" = "file:///home/l1npengtul/nixcfg/applications/individual/audacity.nix";
      "kate/anonymous.katesession"."Document 19"."URL" = "file:///home/l1npengtul/nixcfg/applications/individual/audacious.nix";
      "kate/anonymous.katesession"."Document 2"."URL" = "file:///home/l1npengtul/nixcfg/pkgs/sysutils.nix";
      "kate/anonymous.katesession"."Document 20"."URL" = "file:///home/l1npengtul/nixcfg/applications/individual/anki.nix";
      "kate/anonymous.katesession"."Document 3"."URL" = "file:///home/l1npengtul/nixcfg/hosts/clubcyberia/default.nix";
      "kate/anonymous.katesession"."Document 4"."URL" = "file:///home/l1npengtul/nixcfg/applications/individual/default.nix";
      "kate/anonymous.katesession"."Document 5"."URL" = "file:///home/l1npengtul/nixcfg/applications/individual/minecraft.nix";
      "kate/anonymous.katesession"."Document 6"."URL" = "file:///home/l1npengtul/nixcfg/applications/individual/obs.nix";
      "kate/anonymous.katesession"."Document 7"."URL" = "file:///home/l1npengtul/nixcfg/applications/individual/okteta.nix";
      "kate/anonymous.katesession"."Document 8"."URL" = "file:///home/l1npengtul/nixcfg/applications/individual/protonmail.nix";
      "kate/anonymous.katesession"."Document 9"."URL" = "file:///home/l1npengtul/nixcfg/applications/individual/reaper.nix";
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-Sidebar-0-Splitter" = 948;
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-Sidebar-3-Splitter" = 1526;
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-ToolView-kateprojectinfo-Visible" = true;
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-V-Splitter" = "0,747,200";
      ...
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0"."View 10" = 10;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0"."View 11" = 11;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0"."View 12" = 12;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0"."View 13" = 13;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0"."View 14" = 14;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0"."View 15" = 15;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0"."View 16" = 16;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0"."View 17" = 17;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0"."View 18" = 18;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0"."View 19" = 19;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0"."View 2" = 2;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0"."View 20" = 20;
      ...
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0"."View 7" = 7;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0"."View 8" = 8;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0"."View 9" = 9;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 0"."CursorColumn" = 15;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 0"."CursorLine" = 228;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 0"."ScrollLine" = 189;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 1"."CursorColumn" = 18;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 1"."CursorLine" = 62;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 1"."ScrollLine" = 9;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 2"."CursorColumn" = 0;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 2"."CursorLine" = 3;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 3"."CursorColumn" = 10;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 3"."CursorLine" = 37;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 4"."CursorColumn" = 16;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 4"."CursorLine" = 31;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 5"."CursorColumn" = 19;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 5"."CursorLine" = 4;
