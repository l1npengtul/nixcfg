{
  programs.plasma = {
    ...
    dataFile = {
      ...
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0"."Active View" = 4;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0"."Count" = 5;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0"."Documents" = "0,1,2,3,4";
      ...
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 0"."CursorColumn" = 35;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 0"."CursorLine" = 18;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 4"."CursorColumn" = 194;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 4"."CursorLine" = 1;
      "kate/anonymous.katesession"."Open Documents"."Count" = 5;
