{
  programs.plasma = {
    enable = true;
    shortcuts = {
      "ActivityManager"."switch-to-activity-a6f9bbeb-3441-4bf7-92a0-380078f2b641" = [];
    ...
    configFile = {
      ...
      "dolphinrc"."General"."ViewPropsTimestamp" = "2025,2,20,1,42,2.751";
      "dolphinrc"."KFileDialog Settings"."Places Icons Auto-resize" = false;
      "dolphinrc"."KFileDialog Settings"."Places Icons Static Size" = 22;
      "kactivitymanagerdrc"."activities"."a6f9bbeb-3441-4bf7-92a0-380078f2b641" = "Default";
      "kactivitymanagerdrc"."main"."currentActivity" = "a6f9bbeb-3441-4bf7-92a0-380078f2b641";
      ...
      "kcminputrc"."Libinput/1267/10946/ELAN902C:00 04F3:2AC2"."Enabled" = false;
      "kcminputrc"."Libinput/1267/12598/ELAN0B00:00 04F3:3136 Touchpad"."Enabled" = true;
      "kcminputrc"."Libinput/1267/12598/ELAN0B00:00 04F3:3136 Touchpad"."NaturalScroll" = true;
      "kcminputrc"."Mouse"."cursorSize" = 48;
      "kcminputrc"."Mouse"."cursorTheme" = "miku-cursor-linux";
      ...
      "kdeglobals"."KFileDialog Settings"."Preview Width" = 230;
      ...
      "kwinrc"."Activities/LastVirtualDesktop"."a6f9bbeb-3441-4bf7-92a0-380078f2b641" = "9267dd3f-8738-4c2a-af3f-1949c53ac82a";
      "kwinrc"."Desktops"."Id_1" = "7a067d58-9952-4e70-9358-aaceb81f123f";
      "kwinrc"."Desktops"."Id_2" = "ea6f68f6-8877-45ed-a250-267f2f496164";
      "kwinrc"."Desktops"."Id_3" = "9267dd3f-8738-4c2a-af3f-1949c53ac82a";
      "kwinrc"."Desktops"."Id_4" = "72906f83-71db-4894-8c75-a9decfff3ed6";
    ...
    dataFile = {
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-Sidebar-3-Splitter" = 1565;
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-V-Splitter" = "0,943,0";
